package com.dinhchieu.ewallet.transaction_service.service.Impl;
...
import com.dinhchieu.ewallet.transaction_service.repository.TransactionRepository;
...
public class TransactionServiceImpl implements TransactionService {
  ...
  @Override
  public DepositFromBankResponse processDepositFromBank(double amount, String bankCode, String accountNumber) {
    ...
    try {
      ...
      return DepositFromBankResponse.builder()
  ...
  // Trừ tiền ví trước
  @Override
  public WithdrawToBankResponse processWithdrawalFromBank(double amount, String bankCode, String accountNumber) {
    try {
      UUID sagaId = UUID.randomUUID();
      UUID userId = SecurityUtils.getAuthenticatedUserId();
      ...
      return WithdrawToBankResponse.builder()
          .transactionId(sagaId.toString())
          .amount(amount)
          .type(TransactionType.WITHDRAWAL)
          .sourceWalletId(userId.toString())
